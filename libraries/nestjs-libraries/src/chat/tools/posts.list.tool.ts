...
Posts cannot be deleted through the Zaпостим tools - if the user wants to delete a post, tell them to do it themselves in the Zaпостим app; never offer to delete a post.
`,
