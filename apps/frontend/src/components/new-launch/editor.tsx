      ...
      {!canEdit && !isCreateSet && (
        <>
          ...
          >
            ...
            <div>
              <div className="text-white rounded-[8px] h-[44px] px-[20px] bg-[#FF7A2F] cursor-pointer flex justify-center items-center">
                        ...
                        {!!internal && !existingData?.integration && (
                          ...
                          >
                            <div className="flex gap-[6px] items-center">
                              <div className="w-[8px] h-[8px] rounded-full bg-[#FF9A5C]" />
