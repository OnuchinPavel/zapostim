    ...
    <div ref={ref} className="relative">
      <div
        ...
        className={clsx(
          ...
          currentDelay > 0 && 'bg-[#FF7A2F] text-white rounded-full'
        )}
      >
        <DelayIcon />
      </div>
            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[#4340E8] text-white hover:bg-[#4340E8]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              <input
                ...
                className={clsx(
                  'flex-1 w-full h-[32px] px-[8px] rounded-[4px] bg-newBgColor border text-[13px] outline-none focus:border-[#4340E8]',
                  isCustomDelay ? 'border-[#4340E8]' : 'border-newTextColor/10'
                )}
              />
              <button
                onClick={(e) => {
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-[#4340E8] text-white text-[12px] font-[600] hover:bg-[#4340E8]/80"
              >
                Set
              </button>
            </div>
