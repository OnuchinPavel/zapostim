      ...
      <div className="flex flex-1 bg-newBgColorInner rounded-[20px] flex-col">
              ...
              >
                <div className="flex-1 flex flex-col rounded-[12px] gap-[12px] overflow-hidden bg-newSettings">
                  <div
                    ...
                    className={clsx(
                      'bg-[#4340E8] rounded-[12px] flex items-center gap-[8px] cursor-pointer p-[12px]',
        ...
        <div className="select-none h-[84px] py-[20px] border-t border-newBorder flex items-center">
          ...
          <div className="pe-[20px] flex items-center justify-end gap-[8px]">
            ...
            {addEditSets && (
              <button
                className="text-white text-[15px] font-[600] min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[8px] bg-[#4340E8] ps-[20px] pe-[16px]"
                disabled={
                  selectedIntegrations.length === 0 || loading || locked
                }
                onClick={schedule('draft')}
            ...
            {!addEditSets && (
              <div className="group cursor-pointer relative">
                <button
                  ...
                  className="text-white relative min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[8px] bg-[#4340E8] ps-[20px] pe-[16px]"
                >
                  {loading && (
                    <div className="absolute left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%]">
                ...
                {!dummy && (
                  ...
                  >
                    <div className="text-white rounded-[8px] bg-[#FF7A2F] h-[44px] w-full flex justify-center items-center post-now">
                      {t('post_now', 'Post Now')}
                    </div>
                  </button>
                )}
