        ...
        >
          <div className="flex-1">
            <input
              ...
              className="w-full h-[44px] px-[14px] rounded-[8px] bg-newBgColorInner border border-newColColor text-[14px] outline-none focus:border-[#4340E8]"
            />
          </div>
          <input
            type="file"
                ...
                >
                  ...
                  >
                    {!!selected.find((p: any) => p.id === media.id) ? (
                      <div className="text-white flex z-[101] justify-center items-center text-[14px] font-[500] w-[24px] h-[24px] rounded-full bg-[#4340E8] absolute -bottom-[10px] -end-[10px]">
          ...
          <div className="flex justify-end mt-[32px] gap-[8px]">
            ...
            {!isLoading && !!data?.results?.length && (
              <button
                ...
                className="cursor-pointer text-white disabled:opacity-80 disabled:cursor-not-allowed h-[52px] px-[20px] items-center justify-center bg-[#4340E8] flex rounded-[10px]"
              >
