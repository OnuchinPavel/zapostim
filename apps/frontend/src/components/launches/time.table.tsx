    ...
    <div className="relative w-full max-w-[400px] mx-auto">
      ...
      <div className="bg-newBgColorInner rounded-[12px] p-[20px] border border-newTableBorder">
        <div className="text-[15px] font-semibold mb-[16px] flex items-center gap-[8px]">
          <DelayIcon size={18} className="text-[#4340E8]" />
        ...
        <div className="flex gap-[12px] items-end">
          ...
          <button
            type="button"
            onClick={addHour}
            className="h-[42px] px-[16px] bg-[#4340E8] hover:bg-[#7640e0] transition-colors rounded-[8px] flex items-center gap-[6px] text-white text-[14px] font-medium"
          >
            <PlusIcon size={14} />
            {t('add', 'Add')}
          </button>
            ...
            {times.map((timeSlot, index) => (
              <div
                ...
                className={clsx(
                  ...
                  'hover:border-[#4340E8]/40 transition-colors'
                )}
              >
                <div className="flex items-center gap-[12px]">
                  <div className="w-[8px] h-[8px] rounded-full bg-[#4340E8]" />
