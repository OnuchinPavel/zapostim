  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isOpen ? 'border-[#4340E8]' : 'border-newTextColor/10'
      )}
    >
      <div
      ...
      {isOpen && (
        <div className="z-[300] absolute start-0 bottom-[100%] w-[240px] bg-newBgColorInner p-[12px] menu-shadow -translate-y-[10px] flex flex-col">
          ...
          <div
            onClick={addTag}
            className="cursor-pointer gap-[8px] flex w-full h-[34px] rounded-[8px] mt-[12px] px-[16px] justify-center items-center bg-[#4340E8] text-white"
          >
            <div>
              <PlusIcon />
            </div>
