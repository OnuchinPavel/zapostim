      ...
      <div className="flex flex-col gap-[40px]">
        <div className="text-[14px] text-textColor leading-[1.7]">
          {t(
            ...
            'Create an OAuth App to let other Zaпостим users authorize your product to post on their behalf.'
          )}
          <br />
          {t(
        ...
        <div className="bg-newBgColorInner rounded-[12px] border border-newBorder overflow-hidden">
            ...
            <div>
              ...
              <div className="text-[13px] text-customColor18 mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with Zaпостим on behalf of your users.'
                )}
              </div>
            </div>
          ...
          <div className="p-[20px]">
            <button
              ...
              className="cursor-pointer px-[20px] h-[44px] bg-[#4340E8] hover:bg-[#5520CB] transition-colors text-white rounded-[8px] text-[15px] font-[600]"
            >
