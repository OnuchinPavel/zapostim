    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-[#4340E8] rounded-full blur-[120px]" />
          <div className="absolute bottom-[20%] right-[10%] w-[250px] h-[250px] bg-[#FF9A5C] rounded-full blur-[120px]" />
        </div>
        <div className="relative z-10 text-center">
          ...
          <div className="mt-[32px] flex justify-center">
            <div className="w-[48px] h-[48px] border-[3px] border-[#4340E8] border-t-transparent rounded-full animate-spin" />
          </div>
        </div>
      </div>
    );
        ...
        <div className="bg-[#1A1919] rounded-[16px] p-[32px] flex flex-col gap-[24px]">
          ...
          <div className="border-t border-[#2A2929] pt-[16px]">
            <div className="text-[14px] text-gray-400 mb-[12px]">
              This application is requesting access to your Zaпостим account. It
              will be able to:
            </div>
          ...
          <div className="flex gap-[12px]">
            <button
              ...
              disabled={submitting}
              className="flex-1 bg-[#4340E8] hover:bg-[#7B3FF2] disabled:opacity-50 text-white rounded-[8px] py-[10px] px-[16px] text-[14px] font-semibold transition-colors"
            >
              Authorize
            </button>
            <button
